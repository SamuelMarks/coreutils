...
#ifdef COMPILING_SRC
#define PSAME_INODE(a, b) (! (((a)->st_dev ^ (b)->st_dev) | ((a)->st_ino ^ (b)->st_ino)))
...
#ifdef COMPILING_SRC
#ifndef UT_TYPE_LOGIN_PROCESS
#define UT_TYPE_LOGIN_PROCESS(UT) ((UT)->ut_type == 6)
#endif
#endif
#ifdef COMPILING_SRC
#include <stdbool.h>
...
#ifdef COMPILING_SRC
#include <sys/types.h>
extern int xcopy_acl(const char*, int, const char*, int, mode_t);
extern int xset_acl (char const *, int, mode_t);
#endif
#ifdef COMPILING_SRC
#include "stat-size.h"
#endif
